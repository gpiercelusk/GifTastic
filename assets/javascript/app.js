...
var topics = ["Alpacas", "Cooking", "Baking", "Arctic Monkyes", "The Beatles", "One Piece", "Dethklok", "Chocolate", "Schnauzer", "Vinyl", "Primus", "Ska"];
...
function renderButtons() {
  ...
  for (var i = 0; i < topics.length; i++) {
    ...
    a.addClass("topic-btn btn btn-warning col-xs-12 col-sm-6 col-md-3 col-lg-2");
    ...
    .then(function (response) {
      ...
      for (var i = 0; i < results.length; i++) {
        ...
        if (results[i].rating !== "r" && results[i].rating !== "pg-13") {
          ...
          var gifDiv = $("<div>");
          gifDiv.addClass("thingsILike col-xs-12 col-sm-6 col-md-3 col-lg-2")
